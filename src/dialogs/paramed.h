...
/* modifyparam_id(display, world, tile)
 * Modify the parameter for the given stat ID
 */
...
/* buildparamdialog_id(world, tile)
 * Builds and returns a param dialog based on the tile
 * at the given stat ID in the given world
 */
...
/* parameditoption_id(display, world, tile, option)
 * Edit the params for the tile at the given stat ID in
 * the context of the given option.
 * Returns true if change occured
 */
...
/* paramdeltaoption(display, world, tile, option, delta)
 * Increase/Decrease option by given delta amount.
 * Returns true if change occured
 */
...
/* tileinfo_id(display, world, x, y, tile)
 * Display/edit info for the current tile
 */
...
/* buildtileinfodialog_id(world, x, y, tile)
 * Builds info for dialog for a tile
 */
dialog buildtileinfodialog_id(ZZTworld * w, int x, int y, ZZTtile);
...
/* tileinfoeditoption_id(display, world, x, y, t, option)
 * Edit a tile info option */
